...
namespace Catalog.Cmd.Command.Controllers
{
    ...
    {
        private readonly ILogger<ProductDeleteController> _logger;
        private readonly ICommandDispatcher _commandDispatcher;

        public ProductDeleteController(ILogger<ProductDeleteController> logger, ICommandDispatcher commandDispatcher)
        {
            this._logger = logger;
        ...
        [HttpPut]
        public async Task<ActionResult> ProductEdit(ProductDeleteCommand command)
        {
            try
            {
